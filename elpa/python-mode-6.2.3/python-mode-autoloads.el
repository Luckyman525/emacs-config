...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "python-mode" '("IPython" "Ipython" "Python" "ar--" "autopair-mode" "druck" "durck" "empty-line-p" "eva" "ffap-alist" "flake8" "force-py-shell-name-p-o" "highlight-indent-active" "hs-hide-comments-when-hiding-all" "inf" "ios" "ipy" "iyp" "jython-" "pep8" "pios" "pps-emacs-version" "pst-here" "smart-operator-mode" "strip-chars-" "toggle-" "turn-o" "variables-" "virtualenv-")))
