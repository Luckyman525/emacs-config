...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gh-api" '("constructor" "gh-" "logito-log")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gh-auth" '("constructor" "gh-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gh-oauth" '("constructor" "gh-o")))
